...
def values3(mess):
    bot.send_message(mess.chat.id, "درباره بیالـرن\nما در بیالرن خیلی کارا انجام می دیم و من برای این موضوع خیلی تلاش می کنم و این تلاش باعث میشه که خیلی کار خوبی نباشه و جذابیت کار کم باشه درباره بیالـرن\nما در بیالرن خیلی کارا انجام می دیم و من برای این موضوع خیلی تلاش می کنم و این تلاش باعث میشه که خیلی کار خوبی نباشه و جذابیت کار کم باشه درباره بیالـرن\nما در بیالرن خیلی کارا انجام می دیم و من برای این موضوع خیلی تلاش می کنم و این تلاش باعث میشه که خیلی کار خوبی نباشه و جذابیت کار کم باشه")
...
def contact6(mess):
    bot.send_photo(mess.chat.id, open("360_F_337963325_EJuPjWslX3vAFxJ59L3y1cm6IsSfo07s.jpg", "rb"), caption="برای ارتباط با ما باید در ایستاگرام و لیکدین با ما ارتباط برقرار کنید و از این روش ها و زیبایی هایی خاصی را در بر دارد")
